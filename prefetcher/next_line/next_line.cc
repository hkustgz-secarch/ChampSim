                                             ...
                                             uint32_t metadata_in)
{
  ...
  // prefetch_line(champsim::address{pf_addr + 10}, true, metadata_in);
  prefetch_line(champsim::address{pf_addr + 20}, true, metadata_in);
  // prefetch_line(champsim::address{pf_addr + 30}, true, metadata_in);
  return metadata_in;
}
